...
<body>
	...
	<img class = "coverPhoto" src = "driveroption.png" align = center />
	<div class="grid-item">
	<center>
	...
	<form>
	<a class = "link" href="driverinsert.jsp" target="_self">Register</a><br>
	<br>
	<a class = "link" href="login.jsp" target="_self">Login</a><br>
	<br>
	</form>
