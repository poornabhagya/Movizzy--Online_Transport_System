...
<body>
	...
	<table>
		...
		<tr>
			...
			<td><input type="text" name="vehicalNo" value="<%= vehicalNo %>"readonly></td>
		</tr>
		<tr>
			<td><p>Vehical Type</p></td>
			<td><input type="text" name="vehicalType" value="<%= vehicalType %>"readonly></td>
		</tr>
		<tr>
			<td><p>License number</p></td>
			<td><input type="text" name="licenseNo" value="<%= licenseNo %>"readonly></td>
		</tr>
		<tr>
			<td><p>User name</p></td>
		...
		<br>
		<input type="submit" name="submit" value="Delete My Account" class="registerbtn">
		</form>
		</div>
